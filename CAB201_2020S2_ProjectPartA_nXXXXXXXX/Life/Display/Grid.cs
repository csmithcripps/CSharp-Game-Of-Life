...
namespace Display
{
    ...
    public class Grid
    {
        ...
        /// <summary>
        /// Resizes the window to the appropriate size
        /// </summary>
        ...
        /// <summary>
        /// Reverts the window back to it's original state.
        /// </summary>
        ...
        /// <summary>
        /// Sets the footnote that appears to the bottom left of the grid.
        /// </summary>
